...
int main(){
    ...
    matrix.compress();
    matrix.uncompress(); //something goes wrong:wrong value: returns 0 element!
    ...
    std::cout<<matrix(43,34)<<std::endl; //accessing after compressing doesn't go well
